<div align="center">
  ...
  <h1>🛡️ CryptoGuard <br/> <span>AI-Powered Risk Intelligence Platform</span></h1>
  
  <p>
    <strong>Don't trade blind. Understand crypto risk <i>before</i> you invest.</strong>
  </p>
...
3. **Configure Environment Variables:**
   Rename `.env.example` to `.env` (if applicable) and add necessary API keys:
   ```env
...
5. **Open in browser:** 
   Navigate to `http://localhost:5173` to see the app live.
...
<details>
<summary><b>Coin Scanner</b></summary>
<br>
Navigate to <strong>Coin Scanner</strong> (`/scanner`) and paste a token contract address. View the generated safety dials highlighting liquidity risk, code audits, and social sentiment.
</details>

<details>
<summary><b>AI Trading Simulator</b></summary>
<br>
Open the <strong>AI Assistant</strong> (`/assistant`) to chat with the threat intel bot. Use the built-in modal to simulate buy/sell scenarios and see projected risks without using real money.
</details>
...
<div align="center">
  <br/>
  <sub>Built with ❤️ for a safer Web3 ecosystem.</sub>
</div>
